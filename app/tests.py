...
from app.views import supplierlistview, productlistview, customerlistview
...
class CustomerModelTests(TestCase):
    def setUp(self):
        Customer.objects.create(customername="Minnan lounaskahvila", address="Viistokuja 8", phone="060432675", email="minna@kahvila.fi", country="Finland")
        
    def test_added_customer_exists(self):
        """Added customer exists and can be searched"""
        customer = Customer.objects.get(customername="Minnan lounaskahvila")
        self.assertEqual(customer.address, "Viistokuja 8")
        self.assertEqual(customer.country, "Finland")
